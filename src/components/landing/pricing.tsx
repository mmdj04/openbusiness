...
import { Check, ArrowRight, Wand2, Settings } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="text-muted-foreground mt-4 text-lg">
            Monte seu plano escolhendo o segmento e os módulos que precisa. Sem
            surpresas, sem taxa escondida.
          </p>
        </div>

        <Card className="mx-auto mt-16 max-w-lg overflow-visible">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Configure de acordo com o segmento e a necessidade do seu negócio
            </CardDescription>
